...
"""
This script gets or updates the environments_protection table.
...
aws_account_name [-n] - Required only when updating product autoscaling group
env_status [-s] - Sets is_running on an environment (Accepts: on/off/true/false/yes/no)
Examples:
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a get-service -r ops-machine
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a update-service -r ops-machine -d 1
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a get-asg -r ASG_NAME -n AWS_ACCOUNT_NAME
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a update-asg -r ASG_NAME -d 5 -n AWS_ACCOUNT_NAME
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a get-all-services
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a add-issuer -i geek-kb
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a add-environment
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a check-protection
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a protect -t "10-11-22 22:00:00"
python3 environments_protection_dynamodb.py -a get-protected-environments
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a unprotect
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a set-environment-status -s on
python3 environments_protection_dynamodb.py -e ENVIRONMENT_NAME -a check-environment-status
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--aws-account-name", help="processing or commercial")
